...
// LOCAL STOREG
const addcat = () => {
    let cname = document.catfrm.hname.value;
    ...
    if (data != null) {
        data.forEach((i) => {
            tr += `<tr>
                ...
                <button type="button" class="btn btn-danger" onclick="delData(${i.id})">Delete</button></td>
...
const editData=(id)=>{
    ...
    finRsult.map((i)=>{
    document.catfrm.hname.value  = i.catname;
